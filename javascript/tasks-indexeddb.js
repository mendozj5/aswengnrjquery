/*-----------------------------------------------------------------------------------------*
 *More sophisticated API than web storage.  It is an object database.  Indexed DB
 *always operates with asynch callbacks, but by default it does still use the main
 *browser thread.  It is also possible for browser vendors  to implement the IndexedDB
 *API with Web Workers.
 *-----------------------------------------------------------------------------------------*/
...
*/
		...
		initObjectStore:function(type, successCallback, errorCallback) {
			...
			var exists = false; 
			$. each(database.objectStoreNames, 
					function(i, v){
						if (v==type) { 
							exists=true; 
						} 
